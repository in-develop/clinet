  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "focus-visible:border-ring focus-visible:ring-ring/50 group text-light-black flex flex-1 cursor-pointer items-center justify-between gap-4 text-left font-bold transition-all outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50",
          className,
        )}
        {...props}
      >
        ...
        {indicator === "plus" ? (
          ...
          <div>
            <SvgIcon
              ...
              className={
                "size-4 rotate-90 transition-transform duration-300 ease-out group-data-[state=open]:-rotate-90"
              }
            />
          </div>
        )}
